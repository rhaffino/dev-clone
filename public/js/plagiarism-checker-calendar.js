...
function getCalendar(data) {
  ...
  return $.ajax({
    ...
    error: function error(e) {
      ...
      /* eslint-disable */
      (_console = console).log.apply(_console, _toConsumableArray(oo_oo("13cd77b0_0", 'error', e)));
    ...
    failed: function failed() {
      ...
      /* eslint-disable */
      (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("13cd77b0_1", 'failed')));
