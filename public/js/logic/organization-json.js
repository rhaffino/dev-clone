...
let placeholder_url = lang === "en" ? "URL here.." : "URL di sini..";
let label_type_contact = lang === "en" ? "Type Contact" : "Tipe Kontak";
let placeholder_type_contact = lang === "en" ? "Search a type contact.." : "Cari tipe kontak..";
let opt_type_contact_1 = lang === "en" ? "Customer Service" : "Layanan Pelanggan";
let opt_type_contact_2 = lang === "en" ? "Technical Support" : "Bantuan Teknis";
let opt_type_contact_3 = lang === "en" ? "Billing Support" : "Bantuan Pembayaran";
let opt_type_contact_4 = lang === "en" ? "Bill Payment" : "Pembayaran Tagihan";
let opt_type_contact_5 = lang === "en" ? "Sales" : "Penjualan";
let opt_type_contact_6 = lang === "en" ? "Reservations" : "Reservasi";
let opt_type_contact_7 = lang === "en" ? "Credit Card Support" : "Bantuan Kartu Kredit";
let opt_type_contact_8 = lang === "en" ? "Emergency" : "Darurat";
let opt_type_contact_9 = lang === "en" ? "Baggage Tracking" : "Pelacakan Bagasi";
let opt_type_contact_10 = lang === "en" ? "Readside Tracking" : "Lacak Pengiriman";
let opt_type_contact_11 = lang === "en" ? "Package Tracking" : "Lacak Paket";
let label_phone = lang === "en" ? "Phone" : "Telepon";
let placeholder_phone = lang === "en" ? "Type your number phone here.." : "Ketik nomor telepon Anda di sini..";
let label_area_served = lang === "en" ? "Area(s) Served" : "Wilayah Layanan";
let label_language = lang === "en" ? "Language(s)" : "Bahasa";
let label_options = lang === "en" ? "Options" : "Pilihan";
let opt_options_1 = lang === "en" ? "Toll Free" : "Bebas Pulsa";
let opt_options_2 = lang === "en" ? "Hearing Impaired Support" : "Dukungan Penyandang Tuna Rungu";
