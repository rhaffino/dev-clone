...
let label_days_week = lang === "en" ? "Day(s) of the week" : "Hari";
let label_openat = lang === "en" ? "Open at" : "Buka pukul";
let placeholder_openat = lang === "en" ? "e.g 08:00" : "contoh 08:00";
let label_closeat = lang === "en" ? "Close at" : "Tutup pukul";
...
let label_type_department = lang === "en" ? "Local Business Type" : "Tipe Bisnis Lokal";
let placeholder_type_department = lang === "en" ? "Local Business" : "Bisnis Lokal";
let label_specific_department = lang === "en" ? "More Specific Type" : "Tipe Spesifik";
let placeholder_specific_department = lang === "en" ? "More Specific" : "Lebih Spesifik";
let label_name_department = lang === "en" ? "Name" : "Nama";
let placeholder_name_department = lang === "en" ? "Type your name business here.." : "Masukkan nama bisnis Anda..";
let label_image_department = lang === "en" ? "Image URL" : "URL gambar";
let placeholder_image_department = lang === "en" ? "Type your Image URL here.." : "Masukkan URL gambar Anda..";
let label_phone_department = lang === "en" ? "Phone" : "Nomor Telepon";
let placeholder_phone_department = lang === "en" ? "Type your phone number here.." : "Masukkan nomor telepon Anda di sini..";
...
$(document).on("click", "#add-department", function(){
    ...
    jQuery.ajax({
        ...
        success: function (data) {
            jQuery.each(data, function (key, value) {
                clearSelect();
                jQuery('#localBusinessType-'+ departmentCounter +'').append(
                    '<option value="' +
                        value.localBusinessType +
                        '">' +
                        value.localBusinessType +
    ...
    localBusinessFormat.department.push({
        "@type": "LocalBusiness",
        name: "",
        image: "",
        telephone: "",
