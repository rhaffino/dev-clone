...
return [
    ...
    "howto1" => '<h2>How to Use the Product Schema Generator?</h2>
                    ...
                    <h4 class="sub-titles">Go to JSON-LD Product Schema Generator Page</h4>
    ...
    "howto2" => '<p>Figure 1: Display of the product schema generator page from cmlabs.</p>
    ...
    "howto3" => '<p>Figure 2: Enter the product name, product image URL, and brand name into the product schema generator.</p>
    ...
    "howto4" => '<p>Figure 3: Select the identification type and enter the required data into the product schema generator.</p>
    ...
    "howto5" => '<p>Figure 4: Enter the product description into the product schema generator.</p>
    ...
    "howto6" => '<p>Figure 5: Enter the type, product URL, currency, price, and other required information into the product schema generator.</p>
    ...
    "howto7" => '<p>Figure 6: Enter the bid type, product url, currency, highest price, bid amount, and other required information into the product schema generator.</p> 
    ...
    "howto8" => '<p>Figure 7: Enter the review name, review content, rating, date, review author, and other required information into the product schema generator.</p>
    ...
    "howto11" => '<p>Figure 10: Data reset option added to the Product schema generator.</p>
