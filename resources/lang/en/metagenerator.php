...
return [
    ...
    "label-url" => "Site URL",
    "placeholder-url" => "Type your URL website here..",
    "label-country" => "What is your site primary language?",
    "placeholder-country" => "Choice your Language",
    "label-revisit" => "Search engines should revisit this page after (Optional)",
    "placeholder-revisit" => "Select Days",
    "revisit-opt-1" => "1 Day",
    "revisit-opt-2" => "2 Days",
    "revisit-opt-3" => "3 Days",
    "revisit-opt-4" => "4 Days",
    "revisit-opt-5" => "5 Days",
    "revisit-opt-6" => "6 Days",
    "revisit-opt-7" => "7 Days",
    "revisit-opt-8" => "8 Days",
    "label-author" => "Author (Optional)",
    "placeholder-author" => "Type your Author here..",
    "label-robots-index" => "Allow robots to index your website?",
    "robots-index-opt-1" => "Yes",
    "robots-index-opt-2" => "No",
    "label-robots-follow" => "Allow robots to follow all links?",
    "robots-follow-opt-1" => "Yes",
    "robots-follow-opt-2" => "No",
    "label-type-content" => "What type of content will your site display?",
    "label-type" => "Type",
    "type-opt-1" => "Website",
    "type-opt-2" => "Article",
    "type-opt-3" => "Book",
    "type-opt-4" => "Book Author",
    "type-opt-5" => "Book Genre",
    "type-opt-6" => "Business",
    ...
    "type-opt-13" => "Object (Generic Object)",
    "type-opt-14" => "Place",
    "type-opt-15" => "Product",
    "type-opt-16" => "Product Group",
    "type-opt-17" => "Product Item",
    "type-opt-18" => "Profile",
    "type-opt-19" => "Election",
    "type-opt-20" => "Restaurant",
    "type-opt-21" => "Restaurant Menu",
    "type-opt-22" => "Restaurant Menu Item",
    "type-opt-23" => "Restaurant Menu Section",
