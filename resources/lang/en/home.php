...
return [
    ...
    "json-ld-desc" => "Enabling rich snippets for a website on SERP becomes easier with JSON LD FAQ Schema Generator. Write the questions and the best answers, get the equipped series of code from the tool.",
