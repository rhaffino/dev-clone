...
return [
    ...
    "attendance-opt-0" => "Choice a Attendance Mode..",
    ...
    "label-performer-type" => "Performer @type",
    "performer-type-opt-0" => "Choice a Performer..",
    ...
    "placeholder-url-ticket" => "Type your URL ticket here..",
    "label-availability" => "Availability",
    "availability-opt-0" => "Not Specified",
    "availability-opt-1" => "In Stock",
    "availability-opt-2" => "Sold Out",
    "availability-opt-3" => "Pre-order",
