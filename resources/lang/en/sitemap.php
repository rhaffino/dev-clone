...
return [
    ...
    "howto1" => '<h2>How to Use a Sitemap Generator?</h2>
                    ...
                    <h4 class="sub-titles">Go to Sitemap Generator Page</h4>
    ...
    "howto2" => '<p>Figure 1: Sitemap Generator page view from cmlabs</p>
    ...
    "howto4" => '<p>Figure 3: Display of information that the generator sitemap is crawling data.</p>
    ...
    "howto5" => '<p>Figure 4: List of linked URLs on tracked websites.</p>
    ...
    "howto6" => '<p>Figure 5: List of sitemap generator usage history.</p>
