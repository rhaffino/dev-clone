...
return [
    ...
    "desc-1" => "What is FAQ Schema Generator?",
    "desc-1-1" => "FAQ schema generator is a free tool from cmlabs that can help webmasters to simplify FAQ schemas using JSON-LD format. With just a few clicks, you can generate schema markup without having to manually create it with coding.",
    ...
    "desc-2" => "Advantages of Using FAQ Schema Generator by cmlabs",
    ...
    "howto1-1" => '<h3 class="sub-titles">Open JSON-LD FAQ Schema Generator Page</h4>
    ...
    "howto2" => '<p>Figure 1: View of the schema generator FAQ page from cmlabs.</p>
                    <h3 class="sub-titles">Input Required Data</h4>
    ...
    "howto3" => '<p>Figure 2: Enter the data needed to create the FAQ schema markup.</p>
                    <h3 class="sub-titles">Add New Question</h4>
    ...
    "howto4" => '<p>Figure 3: “Add Question” button on the FAQ schema generator from cmlabs.</p>
                    <h3 class="sub-titles">Delete Question</h4>
    ...
    "howto5" => '<p>Figure 4: Cross icon button to delete FAQ on JSON-LD FAQ schema generator from cmlabs.</p>
                    <h3 class="sub-titles">Copy The Generated Schema Markup FAQ</h4>
    ...
    "howto6" => '<p>Figure 5: Schema markup FAQ copy options</p>
                    <h3 class="sub-titles">Check JSON-LD Script Validity</h4>
    ...
    "howto7" => '<p>Figure 6: Check schema markup FAQ validation options</p>
                    <h3 class="sub-titles">Reset Schema Generator FAQ</h4>
