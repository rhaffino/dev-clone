...
return [
    ...
    "howto2" => '<h3 class="sub-titles">Go to the Redirect Chain Checker Page</h3>
    ...
    "howto3" => '<p>Figure 1: Redirect Chain Checker page view</p>
                    <h3 class="sub-titles">Enter URL</h3>
    ...
    "howto4" => '<p>Figure 2: The display when the user has entered the website URL in the provided field.</p>
                    <h3 class="sub-titles">Select User Agent</h3>
    ...
    "howto5" => '<p>Figure 3: Select the user agent feature in the redirect chain checker</p>
                    <h3 class="sub-titles">Viewing Redirect Check Results</h3>
                    ...
                    <h4 class="sub-titles">Status Code</h4>
                    ...
                    <h4 class="sub-titles">Check Date</h4>
                    ...
                    <h3 class="sub-titles">View Usage History</h3>
