...
return [
    ...
    "howto1" => '<h2>How to Use SSL Certificate Checker</h2>
                    ...
                    <h4 class="sub-titles">Open SSL Certificate Checker page</h4>
    ...
    "howto2" => '<p>Figure 1: Initial view of cmlabs SSL Certificate Checker</p>
    ...
    "howto3" => '<p>Figure 2: Entering the website URL to find out the SSL certificate information</p>
    ...
    "howto4" => '<p>Figure 3: SSL certificate check results</p>
    ...
    "howto5" => '<p>Figure 4: Local History feature to view the history of checking the SSL certificate checker.</p>
