...
return [
    ...
    "desc-1-2" => 'Mungkin Anda pernah menjumpai hasil penelusuran selebriti, tokoh politik, atlet, dan lainnya ditampilkan dalam kotak khusus. Nah, itulah bentuk tampilan dari skema markup Person. Tak hanya berlaku untuk orang terkenal saja, Anda pun dapat menggunakan skema ini untuk tujuan <i class="italics">personal branding.</i>',
    ...
    "desc-2" => "Fungsi Person Schema Generator",
    ...
    "desc-2-2" => 'Informasi tersebut akan membantu <i class="italics">search engine</i> membedakan antara orang yang berbeda dengan nama yang sama. Tak hanya itu, skema ini akan membantu Anda untuk tampil di SERP dan meningkatkan implementasi SEO. ",
    "desc-2-3" => "Selain itu, menghasilkan skema markup dengan tool ini akan membawa sejumlah benefit yaitu:',
    "desc-2-3-1" => 'memberikan informasi spesifik <i class="italics">person</i> dalam pencarian',
