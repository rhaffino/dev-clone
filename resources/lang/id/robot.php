...
return [
    ...
    "howto1" => '<h2>Cara Menggunakan Robots.txt Generator</h2>
                    ...
                    <h4 class="sub-titles">Buka Halaman Robots.txt Generator</h4>
    ...
    "howto2" => '<p>Gambar 1: Tampilan halaman robot.txt generator dari cmlabs</p>
    ...
    "howto3" => '<p>Gambar 2: Tampilan dropdown opsi izin yang diberikan kepada robot default</p>
    ...
    "howto4" => '<p>Gambar 3: Tampilan dropdown opsi penundaan crawl yang diberikan kepada robot default</p>
    ...
    "howto5" => '<p>Gambar 4: Tampilan field untuk memasukkan path sitemap yang terkait dengan URL Anda</p>
    ...
    "howto6" => '<p>Gambar 5: Tombol untuk menambahkan perintah yang akan dieksekusi oleh web crawler</p>
    ...
    "howto7" => '<p>Gambar 6: Pilihan izin akses yang akan diberikan kepada web crawler</p>
    ...
    "howto8" => '<p>Gambar 7: Pilihan user agent yang tersedia di cmlabs robots.txt generator</p>
    ...
    "howto9" => '<p>Gambar 8: Field untuk menambahkan path yang akan dirayapi (crawl) oleh crawler</p>
    ...
    "howto10" => '<p>Gambar 9: Opsi menyalin syntax pada robots.txt generator.</p>
    ...
    "howto11" => '<p>Gambar 10: Opsi ekspor data pada robots.txt generator.</p>
    ...
    "howto12" => '<p>Gambar 11: Opsi hapus data directive pada robots.txt generator</p>
    ...
    "howto13" => '<p>Gambar 12: Opsi reset data pada robots.txt generator.</p>',
