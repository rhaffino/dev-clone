...
return [
    ...
    Robots.txt generator dari cmlabs telah memuat segala perintah yang bisa Anda gunakan untuk membuat file robots.txt, mulai dari menentukan <i style='font-size: 13px!important; color:black;'>user-agent</i>, memasukkan path sitemap, menentukan izin akses (allow atau disallow), hingga mengatur <i style='font-size: 13px!important; color:black;'>crawl-delay</i>.",
    ...
    "desc-5-1-2" => "Yang dimaksud dengan <i style='font-size: 13px!important; color:black;'>user-agent</i> dalam robots.txt adalah jenis web crawler spesifik yang Anda beri perintah untuk melakukan perayapan (crawling). Web crawler ini biasanya berbeda-beda tergantung search engine yang digunakan.",
    "desc-5-1-3" => "Beberapa contoh <i style='font-size: 13px!important; color:black;'>user-agent</i> yang sering digunakan yaitu Googlebot, Googlebot-Mobile, Googlebot-Image, Bingbot, Baiduspider, Gigabot, Yandex, dan sebagainya.",
    "desc-5-2-1" => "Disallow",
