...
return [
    ...
    "account_usage_2" => "Penggunaan Akun",
    "cummulative_usage" => "PENGGUNAAN KUMULATIF",

    "your_request" => "PERMINTAAN ANDA",
    "request" => "PERMINTAAN",
    ...
    "story_lab-desc" => '<span class="green-story-labs">Tingkatkan lalu lintas</span> untuk bisnis Anda',

    "seo_services" => "Layanan SEO",
    "media_buying" => "Pembelian Media Digital",
