...
return [
    ...
    "desc-2-1"=>'Sebagai perusahaan yang membutuhkan sumber daya berkualitas, membuat <i class="italics">job posting</i> adalah hal utama yang dilakukan. Namun, perlu diketahui bahwa  Anda tidak dapat memposting pekerjaan ke Google secara langsung.',
    ...
    "desc-2-3" => 'Urgensi lainnya yaitu, menggunakan skema job posting dapat mengoptimasi website Anda untuk mendapatkan <i class="italics">rich snippet</i> dari Google. <i class="italics">Rich snippet</i> akan menarik lebih banyak audiens relevan pada halaman job posting tersebut.',
    ...
    "desc-3-3" => 'Agar dapat tampil pada <i class="italics">list</i> job posting seperti di atas, Anda harus membantu <i class="italics">search engine</i> untuk memahami halaman lowongan pada website Anda. Caranya adalah dengan menerapkan skema job posting. Fitur ini akan sangat membantu para HR (human resource) untuk menarik lebih banyak kandidat potensial dalam proses rekrutmen.',
