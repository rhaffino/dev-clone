    <div class="container d-flex flex-column justify-content-center align-items-center p-0 py-2">
        <div class="d-flex resource-card">
            ...
            <div class="content">
                ...
                <p class="content__body txt-regular-second">@lang('v2_navbar.blog_desc')
                    <a href="https://cmlabs.co/{{ $local }}-id/become-contributor" class="text-decoration-underline">@lang('v2_navbar.apply')</a>
                </p>
            </div>
        </div>
        <div class="d-flex resource-card">
