                ...
                <div class="container-fluid px-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-lg-block d-none">
                            <a href="https://chromewebstore.google.com/detail/redirect-chain-checker-cm/idopchcomjihlocdhibhmmlomjkejjbg"
                    ...
                    @include('components.cta_form', [
                        'message' => 'Oops, we can’t see your targeted URL. Fix your targeted URL here.',
                    ])
                            ...
                            <div class="col-sm-6 col-md-5 col-lg-6 col-xl-5 d-flex align-items-center py-1">
                                ...
                                @if (session()->has('logged_in') || session()->get('logged_in') == 'true')
                                    <button id="analyze-btn" type="button" class="btn btn-crawl"
                                        name="button">@lang('redirectchecker.check-btn')</button>
                                ...
                                @else
                                    ...
                                    <button id="process-button" type="button"
                                        ...
                                        title="@lang('serp-simulator.serp-btn-tooltip')">@lang('redirectchecker.check-btn')</button>
                                @endif
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body py-4 px-5">
                                    <div class="text-center">
                                        ...
                                        <button type="button" class="btn btn-cancel-disabled" disabled name="button"
                                            id="cancel-request-btn">@lang('layout.cancel-btn')
                                        </button>
                                    </div>
                                </div>
                            </div>
...
@component('layouts.new_ui_design', ['local' => $local, 'blogs' => $blogs, 'seo_terms' => $seo_terms, 'seo_guidelines' => $seo_guidelines])
    ...
    @slot('subcontent_2')
        <div class="d-none" id="description-tab-2">
            ...
            <h3 class="sub-titles">@lang('redirectchecker.desc-2-1-1')</h4>
            ...
            <h3 class="sub-titles">@lang('redirectchecker.desc-2-2-1')</h4>
            <p class="text-black">@lang('redirectchecker.desc-2-2-2')</p>
            <p class="text-black">@lang('redirectchecker.desc-2-2-3')</p>
            <h3 class="sub-titles">@lang('redirectchecker.desc-2-3-1')</h4>
            ...
            <h3 class="sub-titles">@lang('redirectchecker.desc-2-4-1')</h4>
    ...
    @slot('subcontent_3')
        <div class="d-none" id="description-tab-3">
            ...
            <h3 class="sub-titles">@lang('redirectchecker.desc-3-1-1')</h4>
            <p class="text-black">@lang('redirectchecker.desc-3-1-2')</p>
            <h3 class="sub-titles">@lang('redirectchecker.desc-3-2-1')</h4>
    ...
    @component('layouts.new_ui_design', [
        ...
        @slot('how_to_content')
            <div class="d-none" id="how-to">
                ...
                <div class="expand-text">
                    @lang('redirectchecker.howto2')
                    <img class="mb-4" src="{{ asset('/media/images/redirectchecker_instruction_1.webp') }}"
                        alt="HowTo-redirectchecker-1" width="80%">
                    @lang('redirectchecker.howto3')
                    <img class="mb-4" src="{{ asset('/media/images/redirectchecker_instruction_2.webp') }}"
                        alt="HowTo-redirectchecker-2" width="80%">
                    @lang('redirectchecker.howto4')
                    <img class="mb-4" src="{{ asset('/media/images/redirectchecker_instruction_3.webp') }}"
                        alt="HowTo-redirectchecker-3" width="80%">
                    @lang('redirectchecker.howto5')
                    <img class="mb-4" src="{{ asset('/media/images/redirectchecker_instruction_4.webp') }}"
                        alt="HowTo-redirectchecker-4" width="80%">
                    @lang('redirectchecker.howto6')
                    <img class="mb-4" src="{{ asset('/media/images/redirectchecker_instruction_5.webp') }}"
                        alt="HowTo-redirectchecker-5" width="80%">
                    @lang('redirectchecker.howto7')
                    <img class="mb-4" src="{{ asset('/media/images/redirectchecker_instruction_6.webp') }}"
                        alt="HowTo-redirectchecker-6" width="80%">
                    @lang('redirectchecker.howto8')
                </div>
            </div>
        @endslot
