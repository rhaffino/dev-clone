                ...
                <div class="notification-center-card">
                    ...
                    <div class="card-content">
                        ...
                        <p class="mb-4 b2-400 b2-m-400">
                            <span class="text-dark-30">@lang('plagiarism.last_update')</span> Mar 15, 2023
                        </p>
                                ...
                                <a href="/" class="resource-card">
                                    <div class="card-header p-0 m-0">
                                        <img class="img-fluid w-100"
                                            src="{{ asset('media/images/resources-example.png') }}" alt="">
                                    </div>
                                    <div class="card-body">
                                        <div class="text-purple-70 b2-700 b2-m-700">UPCOMING EVENT</div>
                                        <h3 class="h6-700 h-6-m-700 text-dark-70">Make Your Website Accessible for
                                            Everyone</h3>
                            ...
                            <div class="col-12 col-lg-4">
                                <a href="/" class="resource-card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h3 class="h6-700 h-6-m-700 text-dark-70">Google Sandbox: What It Is and How to
                                            Get Out of
                                            It</h3>
                                        <p class="m-0 b2-400 b2-m-400 text-gray-90">24 August 2022</p>
                                    </div>
