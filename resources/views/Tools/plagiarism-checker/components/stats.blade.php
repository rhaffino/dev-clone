    ...
    <div class="card-body p-0 d-flex flex-column flex-lg-row overflow-hidden">
        <div class="col-12 col-lg-6 px-5 pt-4 pb-4 background-white">
            <div class="d-flex gap-4 text-dark-50">
                ...
                <div class="b2-700 b2-m-700 ml-2">ACCOUNT USAGE</div>
            </div>
        ...
        <div class="col-12 col-lg-6 background-dark-70 text-white px-5 pt-4 pb-4">
            <div class="d-flex gap-4">
                ...
                <div class="b2-700 b2-m-700 ml-2">CUMMULATIVE USSAGE</div>
            </div>
            <div class="mt-2 d-flex justify-content-between">
                <div class="">
                    <p class="s-400 s-m-400 m-0">
                        TEAM REQUEST </p>
                    <p class="b1-700 b1-m-700 m-0"> {{ $cummulativeSummaryLogs->team_requests }} times
                    </p>
                </div>
                <div class="">
                    <p class="s-400 s-m-400 m-0">
                ...
                <div class="col-3 flex-shrink-0">
                    <p class="s-400 s-m-400 m-0">
                        TOTAL WORDS </p>
                    <p class="b1-700 b1-m-700 m-0"> {{ $cummulativeSummaryLogs->total_words }} WORDS
                    </p>
                </div>
                <div class="">
                    <p class="s-400 s-m-400 m-0">
