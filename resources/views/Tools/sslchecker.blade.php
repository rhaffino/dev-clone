            ...
            <div class="d-flex flex-column-fluid">
                <div class="container-fluid px-0">
                    ...
                    @include('components.cta_form', [
                        'message' =>
                            'It seems like your website link is not secure. If you need help to enable SSL on your website.',
                    ])
                    ...
                    <div class="header-blue mb-5 px-5 py-1">
                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-sm-9 col-md-10 col-lg-9 col-xl-10 d-flex align-items-center py-1">
                                ...
                                <i id="crawlHttps" style="display: none;"
                                    class='bx bxs-check-shield text-white bx-md mr-3'></i>
                                <i id="crawlHttp" style="display: none;" class='bx bxs-shield-x text-white bx-md mr-3'></i>
                                <input id="url" type="url" class="form-control lookup-url" name=""
                                    value="" autocomplete="off" placeholder="example.com">
                            </div>
                            <div class="col-sm-3 col-md-2 col-lg-3 col-xl-2 d-flex justify-content-end py-1">
                                @if (session()->has('logged_in') || session()->get('logged_in') == 'true')
                                    <button id="crawlButton" type="button" class="btn btn-crawl"
                                        name="button">@lang('sslchecker.btn-check')</button>
                                ...
                                @else
                                    ...
                                    <button id="process-button" type="button"
                                        ...
                                        title="@lang('serp-simulator.serp-btn-tooltip')">@lang('sslchecker.btn-check')</button>
                                @endif
                            </div>
                        </div>
                    </div>
    ...
    @slot('how_to_content')
        ...
        @slot('subcontent_4')
            <div class="d-none" id="description-tab-4">
                ...
                <ol>
                    <li>
                        <h3><b>@lang('sslchecker.desc-4-2-1')</b></h3>
                    </li>
                    <p>@lang('sslchecker.desc-4-2-2')</p>
                    <h4 class="sub-titles">@lang('sslchecker.desc-4-2-1-1')</h4>
                    <p>@lang('sslchecker.desc-4-2-1-2')</p>
                    ...
                    <li>
                        <h3><b>@lang('sslchecker.desc-4-3-1')</b></h3>
                    </li>
                    <p>@lang('sslchecker.desc-4-3-2')</p>
                    <h4 class="sub-titles">@lang('sslchecker.desc-4-3-2-1')</h4>
                    <p>@lang('sslchecker.desc-4-3-2-2')</p>
        ...
        @slot('how_to_content')
            <div class="d-none" id="how-to">
                ...
                <div class="expand-text">
                    @lang('sslchecker.howto2')
                    <img class="mb-4" src="{{ asset('/media/images/sslchecker_instruction_1.webp') }}" alt="HowTo-sslchecker-1"
                        width="80%">
                    @lang('sslchecker.howto3')
                    <img class="mb-4" src="{{ asset('/media/images/sslchecker_instruction_2.webp') }}" alt="HowTo-sslchecker-2"
                        width="80%">
                    @lang('sslchecker.howto4')
                    <img class="mb-4" src="{{ asset('/media/images/sslchecker_instruction_3.webp') }}" alt="HowTo-sslchecker-3"
                        width="80%">
                    @lang('sslchecker.howto5')
                    <img class="mb-4" src="{{ asset('/media/images/sslchecker_instruction_4.webp') }}" alt="HowTo-sslchecker-4"
                        width="80%">
                    @lang('sslchecker.howto6')
                    <img class="mb-4" src="{{ asset('/media/images/sslchecker_instruction_5.webp') }}" alt="HowTo-sslchecker-5"
                        width="80%">
                    @lang('sslchecker.howto7')
                    <img class="mb-4" src="{{ asset('/media/images/sslchecker_instruction_6.webp') }}" alt="HowTo-sslchecker-6"
                        width="80%">
                    @lang('sslchecker.howto8')
                </div>
            </div>
...
@push('script')
    <script>
        const SSL_CHECKER_URL = '{{ route('api.analyze-ssl') }}';
    </script>
