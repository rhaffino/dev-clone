            ...
            <div class="mb-5" id="cta-danger">
                <div class="cta-yellow px-5 py-1 cta-border-bottom cta-border">
                    <div class="row d-flex align-items-center">
                        <div class="col-sm-9 col-md-10 col-lg-9 col-xl-10 d-flex align-items-center py-1">
                            <i class='bx bxs-mobile-vibration bx-md mr-3 text-black'></i>
                            <p class="mb-0 text-black">It seems like your website still hasn't passed our mobile-friendly test. You can discuss your problem with our team by fulfilling your problem here.</p>
                        </div>
                ...
                <div class="cta-white px-5 collapse" id="CTAForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="email" value="" class="form-control" placeholder="Fill Your Problem">
                            </div>
                        </div>
                    </div>
                    <div class="d-flex align-items-center justify-content-end">
                        ...
                        <button type="submit" class="btn btn-send-cta ml-2" name="button">Send</button>
                    </div>
                    </form>
                </div>

            </div>
            <div class="mb-5" id="notif-form-success">
                <div class="cta-green px-5 py-1 cta-border-bottom">
                    <div class="row d-flex align-items-center">
                        <div class="col-sm-9 col-md-10 col-lg-9 col-xl-10 d-flex align-items-center py-1">
                            <i class='bx bxs-check-circle bx-md mr-3 text-green'></i>
                            <p class="mb-0 text-green">Your message has been sent.</p>
                        </div>
                        <div class="col-sm-3 col-md-2 col-lg-3 col-xl-2 d-flex justify-content-end py-1">
