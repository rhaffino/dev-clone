                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-sm-6 col-md-5 col-lg-5 col-xl-7 d-flex align-items-center py-1">
                                ...
                                <input type="url" class="form-control lookup-url" name="" value=""
                                    placeholder="@lang('robot-checker.url-placeholder')" id="input-url" autocomplete="off">
                            </div>
                            <div class="col-sm-6 col-md-7 col-lg-7 col-xl-5 d-flex align-items-center py-1">
                                ...
                                <select id="user-agent"
                                    class="form-control selectpicker custom-select-blue custom-searchbox user-agent mx-2"
                                    data-size="4" data-live-search="true" tabindex="null">
                                ...
                                @if (session()->has('logged_in') || session()->get('logged_in') == 'true')
                                    <button id="crawl-btn" type="button" class="btn btn-crawl" name="button"
                                        data-theme="dark">@lang('robot-checker.btn-check')</button>
                                @elseif (isset($access_limit) && $access_limit > 0)
                                    <button disabled="disabled" type="button" class="btn btn-crawl" name="button"
                                        ...
                                        title="@lang('lookup.lookup-btn-tooltip')">@lang('robot-checker.btn-check')</button>
                                @else
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="px-2 mb-3 d-flex">
                                ...
                                <span class="font-15px font-weight-bolder align-items-center text-green" id="result-status"
                                    style="display: none">200 OK <i
                                        class='bx bxs-check-circle bx-sm ml-1 text-green'></i></span>
                            </div>
                                        ...
                                        <div id="collapseOne2" class="collapse" data-parent="#accordionExample2">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <span class="text-darkgrey h6 mb-0">@lang('layout.updated') 3 Oct,
                                                        2023</span>
                                                </div>
                                            </div>
                                        </div>
        ...
        @slot('how_to_content')
            <div class="d-none" id="how-to">
                ...
                <div class="expand-text">
                    ...
                    <img class="mb-4" src="{{ asset('/media/images/robots_checker_instruction_1.webp') }}"
                        alt="HowTo-Robots-Checker-1 Halaman Tool Robots.txt Checker" width="80%">
                    @lang('robot-checker.howto3')
                    <img class="mb-4" src="{{ asset('/media/images/robots_checker_instruction_2.webp') }}"
                        alt="HowTo-Robots-Checker-2 Periksa URL" width="80%">
                    @lang('robot-checker.howto4')
                    <img class="mb-4" src="{{ asset('/media/images/robots_checker_instruction_3.webp') }}"
                        alt="HowTo-Robots-Checker-3 Results of Robots.txt Checker" width="80%">
