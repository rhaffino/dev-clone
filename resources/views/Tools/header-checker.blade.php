    ...
    @php
        $listData = [
            ...
            [
                'title' => 'Vary',
                'desc' =>
                    'Menjelaskan proses untuk memutuskan apakah akan menggunakan data yang di-cache alih-alih meminta respons baru dari server',
            ],
            [
                'title' => 'Cache Control',
                'desc' => 'Memberikan informasi tentang pilihan cache dalam permintaan dan respons',
            ],
            ...
            [
                'title' => 'X-Powered-By',
                'desc' =>
                    'Potensi penggunaan oleh Hosting dan Framework Server Backend yang dapat mengekspos detail sensitif seperti versi dan perangkat lunak',
            ],
            ...
            [
                'title' => 'Last-Modified',
                'desc' => 'Tanggal modifikasi terbaru dari sumber daya yang membantu dalam caching',
            ],
            [
                'title' => 'X-Content-Type-Options',
                'desc' =>
                    "Menonaktifkan MIME Sniffing untuk memaksa browser mengikuti jenis yang ditunjukkan dalam ‘Content-Type'",
            ],
            [
                'title' => 'ETag',
                'desc' => 'Tag Validasi Cache: Selain itu berfungsi untuk memantau pengguna yang menonaktifkan cookie',
            ],
            [
                'title' => 'X-Frames-Options',
                'desc' => 'Menentukan apakah browser harus menampilkan halaman dalam iFrame',
            ],
            [
                'title' => 'Strict-Transport-Security',
                'desc' => 'Menerapkan penggunaan HTTPS untuk komunikasi (bukan HTTP)',
            ],
            [
                'title' => 'X-XSS-Protection',
                'desc' => 'Mengaktifkan pemfilteran untuk mencegah Cross Site Scripting (XSS)',
            ],
            [
                'title' => 'Expect-CT',
                'desc' =>
                    'Melaporkan dan menerapkan Certificate Transparency, mencegah penggunaan sertifikat yang dikeluarkan secara tidak benar untuk situs yang ada di log CT publik',
            ],
            [
                'title' => 'Accept-Ranges',
                'desc' =>
                    "Dapat merespons permintaan untuk bagian tertentu dari sebuah file, yang juga dikenal sebagai 'byte-range requests'",
            ],
            [
                'title' => 'X-Cache',
                'desc' =>
                    'Digunakan oleh CDN untuk menunjukkan apakah sumber daya dalam cache CDN cocok dengan yang ada di server',
            ],
            ['title' => 'set-cookie', 'desc' => 'Mentransfer cookie dari server ke klien'],
            [
                'title' => 'Age',
                'desc' => 'Durasi dalam hitungan detik saat sumber daya telah disimpan dalam cache proxy',
            ],
            ...
            [
                ...
                'desc' => 'Mengelola sumber daya mana yang diizinkan untuk dimuat oleh klien untuk halaman',
            ],
            ...
            [
                ...
                'desc' =>
                    'Menetapkan aturan yang mengatur bagaimana informasi pengarah yang disediakan di header pengarah disertakan dengan permintaan',
            ],
            [
                'title' => 'X-Request-Id',
                'desc' => 'ID permintaan yang berbeda yang menghubungkan permintaan HTTP antara klien dan server',
            ],
            [
                'title' => 'X-Dc',
                'desc' =>
                    'Mengacu pada kode atau pengenal yang menunjukkan pusat data atau lokasi server tempat permintaan HTTP tertentu diproses atau dilayani',
            ],
            ...
            [
                'title' => 'X-Generator',
                'desc' => 'Mengekspos informasi / meta data tentang situs seperti versi perangkat lunak',
            ],
    ...
    @php
        $listData = [
            ...
            [
                'title' => 'Vary',
                'desc' =>
                    'Explains the process of deciding whether to utilize cached data instead of requesting a new response from the server',
            ],
            [
                'title' => 'Cache Control',
            ...
            [
                'title' => 'X-Powered-By',
                'desc' =>
                    'Potential usage by Hosting and Backend Server Frameworks that could expose sensitive details like version and software',
            ],
            [
                'title' => 'Link',
            ...
            [
                'title' => 'X-Content-Type-Options',
                'desc' =>
                    'Turns off MIME Sniffing to compel the browser to follow the type indicated in the "Content-Type"',
            ],
            [
                'title' => 'CF-RAY',
                'desc' =>
                    'CloudFlare Header. Encodes a hashed value that contains details about the data center and the request',
            ],
            [
                'title' => 'ETag',
            ...
            [
                'title' => 'Accept-Ranges',
                'desc' =>
                    'Can respond to requests for specific portions of a file, also known as "byte-range requests."',
            ],
            [
                'title' => 'Strict-Transport-Security',
            ...
            [
                'title' => 'Expect-CT',
                'desc' =>
                    'Report and enforce Certificate Transparency, preventing the usage of improperly issued certificates for the site are present in public CT logs',
            ],
            [
                'title' => 'X-Cache',
                'desc' =>
                    'Employed by CDNs to indicate whether the resource in the CDN cache matches the one on the server',
            ],
            [
                'title' => 'Set-Cookie',
            ...
            [
                'title' => 'Referrer-Policy',
                'desc' =>
                    'Establish rules governing how referrer information provided in the referrer header is included with request',
            ],
            [
                'title' => 'Report-To',
            ...
            [
                ...
                'desc' =>
                    'Refers to a security directive that outlines which types of cross-domain interactions are allowed for a web application.',
            ],
            [
                'title' => 'X-Proxy-Cache',
            ...
            [
                'title' => 'Etag',
                'desc' =>
                    'Employed for HTTP Cache validation and condition requests through If-Match and Id-None-Match',
            ],
            [
                'title' => 'X-Request-Id',
            ...
            [
                'title' => 'X-Cacheable',
                'desc' =>
                    'Unconventional header linked to caching, with usage differing across various proxy and CDN networks',
            ],
            [
                'title' => 'X-Dc',
                'desc' =>
                    'Refers to a code or identifier that indicates the data center or server location where a particular HTTP request is being processed or served from.',
            ],
            [
            ...
            [
                ...
                'desc' =>
                    'It allows the web page to include specific HTTP headers in the request when making a cross-origin request (a request to a different domain).',
            ],
            [
                'title' => 'server',
            ...
            [
                'title' => 'date',
                'desc' =>
                    'Point in time when the HTTP response was generated and sent from the server. It provides information about when the server responded to the client\'s request.',
            ],
            [
                'title' => 'X-hacker',
            ...
            [
                ...
                'desc' =>
                    'It defines which types of interactions are permitted between different domains, ensuring controlled and secure communication.',
            ],
            [
                'title' => 'X-Litespeed-cache',
                'desc' =>
                    'The term "X-Litespeed-cache" in an HTTP Header context refers to a marker or indicator that provides information about caching mechanisms utilized by the LiteSpeed web server.',
            ],
            [
            ...
            [
                'title' => 'X-seen-By',
                'desc' =>
                    'It gives insight into the route the request or response has taken through various network nodes.',
            ],
            [
            ...
            [
                'title' => 'x-contextid',
                'desc' =>
                    'The term "x-contextid" in an HTTP Header context likely represents a unique identifier or token associated with a specific context or session.',
            ],
            [
            ...
            [
                ...
                'desc' =>
                    'The term "X-Cache-Status" in an HTTP Header context indicates whether the response was retrieved from a cache or generated directly by the server.',
            ],
            [
                'title' => 'Status',
                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-sm-9 col-md-10 col-lg-9 col-xl-10 d-flex align-items-center py-1">
                                ...
                                <input type="url" class="form-control lookup-url" name="" value=""
                                    placeholder="@lang('headerchecker.headerchecker-placeholder')" id="input-url" autocomplete="off">
                            </div>
                            <div class="col-sm-3 col-md-2 col-lg-3 col-xl-2 d-flex justify-content-end py-1">
                                @if (session()->has('logged_in') || session()->get('logged_in') == 'true')
                                    <button id="crawl-btn" type="button" class="btn btn-crawl" name="button"
                                        data-theme="dark">@lang('headerchecker.headerchecker-btn')</button>
                                @elseif (isset($access_limit) && $access_limit > 0)
                                    <button disabled="disabled" type="button" class="btn btn-crawl" name="button"
                                        ...
                                        title="@lang('headerchecker.headerchecker-btn-tooltip')">@lang('headerchecker.headerchecker-btn')</button>
                                @else
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="px-2 mb-3 d-flex">
                                ...
                                <span class="font-15px font-weight-bolder d-flex align-items-center"
                                    id="http-header-result-status"></span>
                            </div>
                            <div class="card card-custom" id="http-header-result-container">
                                <div class="card-body py-4 px-0">
                                    ...
                                    <div class="http-header-result-list mx-5 my-2" id="http-header-result-list"
                                        style="display: none">
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div id="collapseOne2" class="collapse" data-parent="#accordionExample2">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <span class="text-darkgrey h6 mb-0">@lang('layout.updated') 21 Aug,
                                                        2023</span>
                                                </div>
                                            </div>
                                        </div>
    ...
    @component('layouts.new_ui_design', [
        ...
        @slot('subcontent_2')
            <div class="d-none" id="description-tab-2">
                ...
                <ul>
                    <li>
                        <p class="text-black">@lang('headerchecker.desc-2-1-1')</p>
                    </li>
                    <li>
                        <p class="text-black">@lang('headerchecker.desc-2-1-2')</p>
                    </li>
                    <li>
                        <p class="text-black">@lang('headerchecker.desc-2-1-3')</p>
                    </li>
                    <li>
                        <p class="text-black">@lang('headerchecker.desc-2-1-4')</p>
                    </li>
                </ul>
        ...
        @slot('how_to_content')
            <div class="d-none" id="how-to">
                ...
                <div class="expand-text">
                    ...
                    <img class="mb-4" src="{{ asset('/media/images/http_header_instruction_1.webp') }}"
                        alt="HowTo-http_header-1" width="80%">
                    @lang('headerchecker.howto3')
                    <img class="mb-4" src="{{ asset('/media/images/http_header_instruction_2.webp') }}"
                        alt="HowTo-http_header-2" width="80%">
                    @lang('headerchecker.howto4')
                    <img class="mb-4" src="{{ asset('/media/images/http_header_instruction_3.webp') }}"
                        alt="HowTo-http_header-3" width="80%">
                    @lang('headerchecker.howto5')
                    <img class="mb-4" src="{{ asset('/media/images/http_header_instruction_4.webp') }}"
                        alt="HowTo-http_header-4" width="80%">
                    @lang('headerchecker.howto6')
                    @lang('headerchecker.howto7')
                    <img class="mb-4" src="{{ asset('/media/images/http_header_instruction_5.webp') }}"
                        alt="HowTo-http_header-5" width="80%">
                    @lang('headerchecker.howto8')
                    <img class="mb-4" src="{{ asset('/media/images/http_header_instruction_6.webp') }}"
                        alt="HowTo-http_header-6" width="80%">
                    @lang('headerchecker.howto9')
                    <img class="mb-4" src="{{ asset('/media/images/http_header_instruction_7.webp') }}"
                        alt="HowTo-http_header-7" width="80%">
