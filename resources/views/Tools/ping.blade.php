                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-sm-6 col-md-7 col-lg-6 col-xl-7 d-flex align-items-center py-1">
                                ...
                                <input type="url" class="form-control lookup-url" name="" value=""
                                    placeholder="@lang('ping.ping-placeholder')" id="input-url" autocomplete="off">
                            </div>
                            <div class="col-sm-6 col-md-5 col-lg-6 col-xl-5 d-flex align-items-center py-1">
                                ...
                                @if (session()->has('logged_in') || session()->get('logged_in') == 'true')
                                    <button id="crawl-btn" type="button" class="btn btn-crawl" name="button"
                                        data-theme="dark">@lang('ping.ping-btn')</button>
                                @elseif (isset($access_limit) && $access_limit > 0)
                                    <button disabled="disabled" type="button" class="btn btn-crawl" name="button"
                                        ...
                                        title="@lang('lookup.lookup-btn-tooltip')">@lang('ping.ping-btn')</button>
                                @else
    ...
    @component('layouts.new_ui_design', [
        ...
        @slot('subcontent_2')
            <div class="d-none" id="description-tab-2">
                ...
                <ul>
                    <li>
                        <p class="text-black">@lang('ping.desc-2-1-1')</p>
                    </li>
                    <li>
                        <p class="text-black">@lang('ping.desc-2-1-2')</p>
                    </li>
                    <li>
                        <p class="text-black">@lang('ping.desc-2-1-3')</p>
                    </li>
                    <li>
                        <p class="text-black">@lang('ping.desc-2-1-4')</p>
                    </li>
                    <li>
                        <p class="text-black">@lang('ping.desc-2-1-5')</p>
                    </li>
                </ul>
            </div>
        @endslot
        @slot('how_to_content')
            <div class="d-none" id="how-to">
                ...
                <div class="expand-text">
                    @lang('ping.howto2')
                    <img class="mb-4" src="{{ asset('/media/images/ping_instruction_1.webp') }}" alt="HowTo-Ping-1"
                        width="80%">
                    @lang('ping.howto3')
                    @lang('ping.howto4')
                    <img class="mb-4" src="{{ asset('/media/images/ping_instruction_2.webp') }}" alt="HowTo-ping-2"
                        width="80%">
                    @lang('ping.howto5')
                    <img class="mb-4" src="{{ asset('/media/images/ping_instruction_3.webp') }}" alt="HowTo-ping-3"
                        width="80%">
                    @lang('ping.howto6')
                    <img class="mb-4" src="{{ asset('/media/images/ping_instruction_4.webp') }}" alt="HowTo-ping-4"
                        width="80%">
                    @lang('ping.howto7')
                    <img class="mb-4" src="{{ asset('/media/images/ping_instruction_5.webp') }}" alt="HowTo-ping-5"
                        width="80%">
                    @lang('ping.howto8')
                    <img class="mb-4" src="{{ asset('/media/images/ping_instruction_6.webp') }}" alt="HowTo-ping-6"
                        width="80%">
                    @lang('ping.howto9')
                </div>
            </div>
