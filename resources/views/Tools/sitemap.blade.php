                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-sm-3 col-md-2 col-lg-3 col-xl-2 d-flex justify-content-end py-1">
                        ...
                        @else 
                            ...
                            <button id="process-button" type="button" class="btn btn-crawl check-limit-button analysist-button-guest" name="button">@lang('sitemap.btn-generate')</button>
                        @endif
                    </div>
                </div>
            </div>
...
<script src="{{asset('js/logic/sitemap.js')}}?142102023"></script>
