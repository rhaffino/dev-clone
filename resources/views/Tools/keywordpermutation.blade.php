                        ...
                        <div class="col-md-4">
                                ...
                                <div class="card-body p-0">
                                    <div class="container px-4 pt-3">
                                        <div class="d-flex justify-content-between">
                                            <p class="mb-0 text-black"><strong>Word 1</strong>
                                                <small>(@lang('permutation.one-per-line'))</small></p>
                                            <p class="mb-0 text-primaryblue"><span id="count-keyword-box1">0</span>
                                                @lang('permutation.input-card-counter')</p>
                                        </div>
                                    </div>
                                    <hr class="mb-0">
                                    <textarea id="box1" data-autoresize name="name"
                                        placeholder="{{ Lang::get('permutation.textarea-placeholder') }}" rows="7" style="resize:none;"
                                        class="form-control keyword-permutation-text__area"></textarea>
                                </div>
                            </div>
                            <div class="card card-custom mb-5">
                                <div class="card-body p-0">
                                    <div class="container px-4 pt-3">
                                        <div class="d-flex justify-content-between">
                                            <p class="mb-0 text-black"><strong>Word 2</strong>
                                                <small>(@lang('permutation.one-per-line'))</small></p>
                                            <p class="mb-0 text-primaryblue"><span id="count-keyword-box2">0</span>
                                                @lang('permutation.input-card-counter')</p>
                                        </div>
                                    </div>
                                    <hr class="mb-0">
                                    <textarea id="box2" data-autoresize name="name"
                                        placeholder="{{ Lang::get('permutation.textarea-placeholder') }}" rows="7" style="resize:none;"
                                        class="form-control keyword-permutation-text__area"></textarea>
                                </div>
                            </div>
                            <div class="card card-custom mb-5">
                                <div class="card-body p-0">
                                    <div class="container px-4 pt-3">
                                        <div class="d-flex justify-content-between">
                                            <p class="mb-0 text-black"><strong>Word 3</strong>
                                                <small>(@lang('permutation.one-per-line'))</small></p>
                                            <p class="mb-0 text-primaryblue"><span id="count-keyword-box3">0</span>
                                                @lang('permutation.input-card-counter')</p>
                                        </div>
                                    </div>
                                    <hr class="mb-0">
                                    <textarea id="box3" data-autoresize name="name"
                                        placeholder="{{ Lang::get('permutation.textarea-placeholder') }}" rows="7" style="resize:none;"
                                        class="form-control keyword-permutation-text__area"></textarea>
                                </div>
                            </div>
                        ...
                        <div class="col-md-8">
                                ...
                                <div class="card-body px-3 pt-3 pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-lg-4 mb-3">
                                            <div id="btn-container-popup" onclick="showFeedbackCardKw()">
                                                <button id="generator" type="button"
                                                    class="btn btn-generate-permutation btn-block"
                                                    name="button">@lang('permutation.permutation-btn')</button>
                                            </div>
                                        </div>
                                        <div class="col-12" id="custom-text-container" style="display: none">
                                            <div class="row">
                                                <div class="col-md-4 col-lg-4 mb-3">
                                                    <input type="text" class="form-control" id="custom-start-text"
                                                        placeholder="Start Character">
                                                </div>
                                                <div class="col-md-4 col-lg-4 mb-3">
                                                    <input type="text" class="form-control" id="custom-end-text"
                            ...
                            <div class="card card-custom">
                                <div class="card-body p-0">
                                    <div class="container px-4 pt-3">
                                        <div class="d-flex justify-content-between">
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <small id="copy-text"
                                                    class="mb-0 mx-2 text-darkgrey text-hover-underline">@lang('permutation.copy-btn')</small>
                                                <small id="reset"
                                                    class="mb-0 mx-2 text-darkgrey text-hover-underline">@lang('permutation.clear-btn')</small>
                                            </div>
                                            <div class="d-flex justify-content-between">
                                                <p class="mb-0 text-primaryblue"><span id="count-keyword">0</span>
                                                    @lang('permutation.input-card-counter')</p>
                                    ...
                                    <hr class="mb-0">
                                    <textarea id="permutation-textarea-result" readonly data-autoresize name="name"
                                        placeholder="{{ Lang::get('permutation.textarea-result-placeholder') }}" rows="25" style="resize:none;"
                                        class="form-control keyword-permutation-text__area"></textarea>
                                </div>
                            </div>
                        </div>
    ...
    @component('layouts.new_ui_design', [
        ...
        @slot('subcontent_2')
            <div class="d-none" id="description-tab-2">
                ...
                <h3 class="sub-titles">@lang('permutation.desc-2-1-1')</h3>
                <p class="text-black">@lang('permutation.desc-2-1-2')</p>
                <h3 class="sub-titles">@lang('permutation.desc-2-2-1')</h3>
                <p class="text-black">@lang('permutation.desc-2-2-2')</p>
                <h3 class="sub-titles">@lang('permutation.desc-2-3-1')</h3>
        ...
        @slot('subcontent_3')
            <div class="d-none" id="description-tab-3">
                ...
                <h3 class="sub-titles">@lang('permutation.desc-3-1-1')</h3>
                <p class="text-black">@lang('permutation.desc-3-1-2')</p>
                <p class="text-black">@lang('permutation.desc-3-1-3')</p>
                <h3 class="sub-titles">@lang('permutation.desc-3-2-1')</h3>
                <p class="text-black">@lang('permutation.desc-3-2-2')</p>
                <h3 class="sub-titles">@lang('permutation.desc-3-3-1')</h3>
        ...
        @slot('how_to_content')
            <div class="d-none" id="how-to">
                ...
                <div class="expand-text">
                    ...
                    <img class="mb-4" src="{{ asset('/media/images/permutation_instruction_1.webp') }}"
                        alt="HowTo-permutation-1" width="80%">
                    @lang('permutation.howto3')
                    <img class="mb-4" src="{{ asset('/media/images/permutation_instruction_2.webp') }}"
                        alt="HowTo-permutation-2" width="80%">
                    @lang('permutation.howto4')
                    <img class="mb-4" src="{{ asset('/media/images/permutation_instruction_3.webp') }}"
                        alt="HowTo-permutation-3" width="80%">
                    @lang('permutation.howto5')
                    <img class="mb-4" src="{{ asset('/media/images/permutation_instruction_4.webp') }}"
                        alt="HowTo-permutation-4" width="80%">
                    @lang('permutation.howto6')
                    <img class="mb-4" src="{{ asset('/media/images/permutation_instruction_5.webp') }}"
                        alt="HowTo-permutation-5" width="80%">
