                ...
                <div class="container-fluid px-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-lg-block d-none">
                            <a href="https://chromewebstore.google.com/detail/pagespeed-test-cmlabs-seo/nobbcbccegiignfcapabdeegmaehhifo"
                        ...
                        <div class="cta-yellow px-5 py-1 cta-border-bottom">
                            <div class="row d-flex align-items-center">
                                <div class="col-sm-9 col-md-10 col-lg-9 col-xl-10 d-flex align-items-center py-1">
                                    ...
                                    <p class="mb-0 text-black">Good job! Do you wanna make it 100%? Visit our website and
                                        find out for yourself.</p>
                                </div>
                                <div class="col-sm-3 col-md-2 col-lg-3 col-xl-2 d-flex justify-content-end py-1">
                                    <a href="https://cmlabs.co/en-id/pricing/seo-consultant" target="_blank"
                        ...
                        <div class="cta-yellow px-5 py-1 cta-border-bottom">
                            <div class="row d-flex align-items-center">
                                <div class="col-sm-9 col-md-10 col-lg-9 col-xl-10 d-flex align-items-center py-1">
                                    ...
                                    <p class="mb-0 text-black">Your website is still on the standard speed. To speed up your
                                        website, go to this site and get a quote!</p>
                                </div>
                                <div class="col-sm-3 col-md-2 col-lg-3 col-xl-2 d-flex justify-content-end py-1">
                                    <a href="https://cmlabs.co/en-id/pricing/seo-consultant" target="_blank"
                                        rel="noreferrer nofollow external" type="button" class="btn btn-cta"
                    ...
                    @include('components.cta_form', [
                        'message' =>
                            'Ouch! Turns out your website speed is still not good. But you can discuss with us to maximize your website performance.',
                    ])
                    ...
                    <div class="header-blue mb-5 px-5 py-1">
                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-sm-9 col-md-10 col-lg-9 col-xl-10 d-flex align-items-center py-1">
                                ...
                                <i id="crawlHttps" class='bx bxs-check-shield text-white bx-md mr-3'
                                    style="display: none;"></i>
                                <i id="crawlHttp" class='bx bxs-shield-x text-white bx-md mr-3' style="display: none;"></i>
                                <input type="url" id="url" class="form-control pagespeed-url" name=""
                                    value="" autocomplete="off" placeholder="https://example.com">
                            </div>
                            <div class="col-sm-3 col-md-2 col-lg-3 col-xl-2 d-flex justify-content-end py-1">
                                @if (session()->has('logged_in') || session()->get('logged_in') == 'true')
                                    <button id="analysis-button" class="btn btn-crawl"
                                        name="button">@lang('pagespeed.generate-btn')</button>
                                @elseif (isset($access_limit) && $access_limit > 0)
                                    <button disabled = "disabled" type="button" class="btn btn-crawl"
                                        name="button">@lang('pagespeed.generate-btn')</button>
                                @else
                                    <button id="analysis-button" class="next-button" style="display: none"></button>
                                    <button id="process-button" type="button"
                                        class="btn btn-crawl check-limit-button analysist-button-guest"
                                        name="button">@lang('pagespeed.generate-btn')</button>
                                @endif
                            </div>
                        </div>
                                ...
                                <div class="card-body py-4 px-0">
                                    <div class="row justify-content-center px-4" id="pagespeed-tab">
                                        ...
                                        <div class="col-6 col-sm-4 col-md-4 col-lg-4 col-xl">
                                            <div class="circleProgressBar" id="accessibilityPB">
                                                ...
                                                <h2 class="font-weight-bold text-center mb-4 h6 text-black">Accesibility
                                                </h2>
                                            </div>
                                        </div>
                                        <div class="col-6 col-sm-4 col-md-4 col-lg-4 col-xl">
                                            <div class="circleProgressBar" id="practicePB">
                                                ...
                                                <h2 class=" font-weight-bold text-center mb-4 h6 text-black">Best Practices
                                                </h2>
                                            </div>
                                        </div>
                                        <div class="col-6 col-sm-4 col-md-4 col-lg-4 col-xl">
                                    ...
                                    <div class="" id="performance">
                                        <div class="mx-5">
                                            ...
                                            <div class="col">
                                                <div class="">
                                                    <div class="progress progress-red performance result"
                                                        data-percentage="0">
                                                        <span class="progress-left">
                                                            <span class="progress-bar progress-bar-performance"></span>
                                                        </span>
                                            ...
                                            <div class="">
                                                <div class="accordion accordion-light accordion-toggle-arrow performance-audit"
                                                    id="performance-audit"></div>
                                                <div class="accordion accordion-light accordion-toggle-arrow pass-performance-audit"
                                                    id="pass-performance-audit"></div>
                                                <div class="accordion accordion-light accordion-toggle-arrow not-app-performance-audit"
                                                    id="not-app-performance-audit"></div>
                                                <div class="accordion accordion-light accordion-toggle-arrow manual-performance-audit"
                                                    id="manual-performance-audit"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-none" id="accessibility">
                                        <div class="mx-5">
                                            ...
                                            <div class="col">
                                                <div class="">
                                                    <div class="progress progress-red accessibility result"
                                                        data-percentage="0">
                                                        <span class="progress-left">
                                                            <span class="progress-bar progress-bar-accessibility"></span>
                                                        </span>
                                            ...
                                            <div class="">
                                                <div class="accordion accordion-light accordion-toggle-arrow accessibility-audit"
                                                    id="accessibility-audit"></div>
                                                <div class="accordion accordion-light accordion-toggle-arrow pass-accessibility-audit"
                                                    id="pass-accessibility-audit"></div>
                                                <div class="accordion accordion-light accordion-toggle-arrow not-app-accessibility-audit"
                                                    id="not-app-accessibility-audit"></div>
                                                <div class="accordion accordion-light accordion-toggle-arrow manual-accessibility-audit"
                                                    id="manual-accessibility-audit"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-none" id="best-practices">
                                        <div class="mx-5">
                                            ...
                                            <div class="col">
                                                <div class="">
                                                    <div class="progress progress-red best-practices result"
                                                        data-percentage="0">
                                                        <span class="progress-left">
                                                            <span class="progress-bar progress-bar-best-practices"></span>
                                                        </span>
                                            ...
                                            <div class="">
                                                <div class="accordion accordion-light accordion-toggle-arrow best-practices-audit"
                                                    id="best-practices-audit"></div>
                                                <div class="accordion accordion-light accordion-toggle-arrow pass-best-practices-audit"
                                                    id="pass-best-practices-audit"></div>
                                                <div class="accordion accordion-light accordion-toggle-arrow not-app-best-practices-audit"
                                                    id="not-app-best-practices-audit"></div>
                                                <div class="accordion accordion-light accordion-toggle-arrow manual-best-practices-audit"
                                                    id="manual-best-practices-audit"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-none" id="seo">
                                        <div class="mx-5">
                                            ...
                                            <div class="">
                                                <div class="accordion accordion-light accordion-toggle-arrow seo-audit"
                                                    id="seo-audit"></div>
                                                <div class="accordion accordion-light accordion-toggle-arrow pass-seo-audit"
                                                    id="pass-seo-audit"></div>
                                                <div class="accordion accordion-light accordion-toggle-arrow not-app-seo-audit"
                                                    id="not-app-seo-audit"></div>
                                                <div class="accordion accordion-light accordion-toggle-arrow manual-seo-audit"
                                                    id="manual-seo-audit"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-none" id="pwa">
                                        <div class="mx-5">
                                            ...
                                            <div class="">
                                                <div class="accordion accordion-light accordion-toggle-arrow pwa-audit"
                                                    id="pwa-audit"></div>
                                                <div class="accordion accordion-light accordion-toggle-arrow pass-pwa-audit"
                                                    id="pass-pwa-audit"></div>
                                                <div class="accordion accordion-light accordion-toggle-arrow not-app-pwa-audit"
                                                    id="not-app-pwa-audit"></div>
                                                <div class="accordion accordion-light accordion-toggle-arrow manual-pwa-audit"
                                                    id="manual-pwa-audit"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        @slot('how_to_content')
            <div class="d-none" id="how-to">
                ...
                <div class="expand-text">
                    ...
                    <img class="mb-4" src="{{ asset('/media/images/pagespeed_instruction_1.webp') }}" alt="HowTo-pagespeed-1"
                        width="80%">
                    @lang('pagespeed.howto3')
                    <img class="mb-4" src="{{ asset('/media/images/pagespeed_instruction_2.webp') }}" alt="HowTo-pagespeed-2"
                        width="80%">
                    @lang('pagespeed.howto4')
                    <img class="mb-4" src="{{ asset('/media/images/pagespeed_instruction_3.webp') }}" alt="HowTo-pagespeed-3"
                        width="80%">
                    @lang('pagespeed.howto5')
                    <img class="mb-4" src="{{ asset('/media/images/pagespeed_instruction_4.webp') }}" alt="HowTo-pagespeed-4"
                        width="80%">
                    @lang('pagespeed.howto6')
                    <img class="mb-4" src="{{ asset('/media/images/pagespeed_instruction_5.webp') }}" alt="HowTo-pagespeed-5"
                        width="80%">
                    @lang('pagespeed.howto7')
                    <img class="mb-4" src="{{ asset('/media/images/pagespeed_instruction_6.webp') }}" alt="HowTo-pagespeed-6"
                        width="80%">
                    @lang('pagespeed.howto8')
                    <img class="mb-4" src="{{ asset('/media/images/pagespeed_instruction_7.webp') }}" alt="HowTo-pagespeed-7"
                        width="80%">
                    @lang('pagespeed.howto9')
                    <img class="mb-4" src="{{ asset('/media/images/pagespeed_instruction_8.webp') }}" alt="HowTo-pagespeed-8"
                        width="80%">
                    @lang('pagespeed.howto10')
                    <img class="mb-4" src="{{ asset('/media/images/pagespeed_instruction_9.webp') }}" alt="HowTo-pagespeed-9"
                        width="80%">
                    @lang('pagespeed.howto11')
                    <img class="mb-4" src="{{ asset('/media/images/pagespeed_instruction_10.webp') }}"
                        alt="HowTo-pagespeed-10" width="80%">
