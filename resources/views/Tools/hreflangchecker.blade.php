                ...
                <div class="container-fluid px-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-lg-block d-none">
                            <a href="https://chromewebstore.google.com/detail/hreflang-checker-cmlabs-s/bbiejobgmmjcjbnbabamojimombaoiij"
                        ...
                        <div class="cta-yellow px-5 py-1 cta-border-bottom">
                            <div class="row d-flex align-items-center">
                                <div class="col-sm-9 col-md-10 col-lg-9 col-xl-10 d-flex align-items-center py-1">
                                    ...
                                    <p class="mb-0 text-black">We can’t find your hreflang URL. Optimize and fix your issues
                                        immediately. If you need help, check out this link</p>
                                </div>
                        ...
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col-sm-3 col-md-2 col-lg-3 col-xl-2 d-flex justify-content-end py-1">
                                @if (session()->has('logged_in') || session()->get('logged_in') == 'true')
                                    <button id="check-btn" type="button" class="btn btn-crawl"
                                        name="button">@lang('hreflang.check-btn')</button>
                                ...
                                @else
                                    ...
                                    <button id="process-button" type="button"
                                        ...
                                        title="@lang('serp-simulator.serp-btn-tooltip')">@lang('hreflang.check-btn')</button>
                                @endif
                            </div>
                        </div>
                    </div>
                        ...
                        --}}
                            ...
                            <div class="card card-custom mb-5">
                                <div class="card-body py-4 px-0">
                                    <div class="" id=>
                                        <div class="d-flex mx-5 mb-5" id="hreflang-result-header"
    ...
    @component('layouts.new_ui_design', [
        ...
        @slot('subcontent_2')
            <div class="d-none" id="description-tab-2">
                ...
                <ul>
                    <li>
                        <p class="text-black">@lang('hreflang.desc-2-1-1')</p>
                    </li>
                    <li>
                        <p class="text-black">@lang('hreflang.desc-2-1-2')</p>
                    </li>
                </ul>
            </div>
        @endslot
        ...
        @slot('subcontent_5')
            <div class="d-none" id="description-tab-5">
                ...
                <ul>
                    <li>
                        <p class="text-black">@lang('hreflang.desc-5-1-1')</p>
                    </li>
                    <li>
                        <p class="text-black">@lang('hreflang.desc-5-1-2')</p>
                    </li>
                    <li>
                        <p class="text-black">@lang('hreflang.desc-5-1-3')</p>
                    </li>
                    <li>
                        <p class="text-black">@lang('hreflang.desc-5-1-4')</p>
                    </li>
                </ul>
        ...
        @slot('how_to_content')
            <div class="d-none" id="how-to">
                ...
                <div class="expand-text">
                    <img class="mb-4" src="{{ asset('/media/images/hreflang_instruction_1.webp') }}" alt="HowTo-hreflang-1"
                        width="80%">
                    @lang('hreflang.howto2')
                    @lang('hreflang.howto3')
                    <img class="mb-4" src="{{ asset('/media/images/hreflang_instruction_2.webp') }}" alt="HowTo-hreflang-2"
                        width="80%">
                    @lang('hreflang.howto4')
                    <img class="mb-4" src="{{ asset('/media/images/hreflang_instruction_3.webp') }}" alt="HowTo-hreflang-3"
                        width="80%">
                    @lang('hreflang.howto5')
                    <img class="mb-4" src="{{ asset('/media/images/hreflang_instruction_4.webp') }}" alt="HowTo-hreflang-4"
                        width="80%">
                    @lang('hreflang.howto6')
                    <img class="mb-4" src="{{ asset('/media/images/hreflang_instruction_5.webp') }}" alt="HowTo-hreflang-5"
                        width="80%">
                    @lang('hreflang.howto7')
                    <img class="mb-4" src="{{ asset('/media/images/hreflang_instruction_6.webp') }}" alt="HowTo-hreflang-6"
                        width="80%">
