                ...
                <div class="container-fluid px-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-lg-block d-none">
                            <a href="https://chromewebstore.google.com/detail/link-analyzer-cmlabs-seo/fllajeihhfpfpebnbkplefdofjpdkoim"
                    ...
                    @include('components.cta_form', [
                        'message' =>
                            'Watch out, your domain giving free backlinks to other domains. Fix your issues and optimize more.',
                    ])
                        ...
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col-sm-3 col-md-2 col-lg-3 col-xl-2 d-flex justify-content-end py-1">
                                @if (session()->has('logged_in') || session()->get('logged_in') == 'true')
                                    <button id="analyze-btn" type="button" class="btn btn-crawl"
                                        name="button">@lang('analyzer.analyze-btn')</button>
                                ...
                                @else
                                    ...
                                    <button id="process-button" type="button"
                                        ...
                                        title="@lang('serp-simulator.serp-btn-tooltip')">@lang('analyzer.analyze-btn')</button>
                                @endif
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="mt-7" id="analyzer-container" style="display: none">
                                            ...
                                            <div class="col-lg-7 col-md-7 d-flex align-items-center resultTable mb-5">
                                                <table>
                                                    <thead>
                                                        <tr height="25px">
                                                            <th></th>
                                                            <th style="width:120px" class="font-weight-bolder">Total Links
                                                            </th>
                                                            <th style="width:60px" class="font-weight-bolder"
                                                                id="total-links-value">0</th>
                                                            <th class="font-weight-normal" id="percentage-links-value">100%
                                                            </th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr height="25px">
                                                            <td><span
                                                                    class="label label-dot label-internal label-xl mr-1"></span>
                                                            </td>
                                                            <td class="font-weight-bolder">Internal Links</td>
                                                            <td class="font-weight-bolder" id="internal-links-value">0</td>
                                                            <td class="font-weight-normal" id="internal-links-percentage">0%
                                                            </td>
                                                        </tr>

                                                        <tr height="25px">
                                                            <td><span
                                                                    class="label label-dot label-external label-xl mr-1"></span>
                                                            </td>
                                                            <td class="font-weight-bolder">External Links</td>
                                                            <td class="font-weight-bolder" id="external-links-value">0</td>
                                                            <td class="font-weight-normal" id="external-links-percentage">0%
                                                            </td>
                                                        </tr>

                                                        <tr height="25px">
                                                            <td><span
                                                                    class="label label-dot label-nofollow label-xl mr-1"></span>
                                                            </td>
                                                            <td class="font-weight-bolder">No-follow</td>
                                                            <td class="font-weight-bolder" id="nofollow-links-value">0</td>
                                                            <td class="font-weight-normal" id="nofollow-links-percentage">
                                                                0%</td>
                                                        </tr>

                                                        <tr height="25px">
                                                            <td><span
                                                                    class="label label-dot label-dofollow label-xl mr-1"></span>
                                                            </td>
                                                            <td class="font-weight-bolder">Do-follow</td>
                                                            <td class="font-weight-bolder" id="dofollow-links-value">0
                                                            </td>
                                                            <td class="font-weight-normal" id="dofollow-links-percentage">
                                                                0%</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                        ...
                                        <nav class="mb-5">
                                            <div class="nav d-flex justify-content-center" id="nav-tab" role="tablist">
                                                <a class="btn btn-result-link active mx-2" data-toggle="tab"
                                                    href="#internal-link-tab" role="tab" aria-controls="nav-home"
                                                    aria-selected="true" id="internal-links-value-tab">Internal Links</a>
                                                <a class="btn btn-result-link mx-2" data-toggle="tab"
                                                    href="#external-link-tab" role="tab" aria-controls="nav-profile"
                                                    aria-selected="false" id="external-links-value-tab">External Links</a>
                                            </div>
                                        </nav>
                                        <div class="tab-content" id="nav-tabContent">
                                            <div class="tab-pane fade show active" id="internal-link-tab" role="tabpanel"
                                                ...
                                                <div class="d-flex align-items-center justify-content-between mx-5 result-row-show-more show-more--btn"
                                                    style="padding-left: 5px; padding-right: 5px;"
                                                    id="show-more-internal">
                                                    <div class="">
                                            ...
                                            <div class="tab-pane fade" id="external-link-tab" role="tabpanel"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card card-custom mb-5">
                                <div class="card-body py-4 px-5">
                                    <div class="text-center">
                                        <p class="text-black font-weight-bold mb-0" id="progress-stop-message">
                                            @lang('layout.robot-sleep')</p>
                                        <p class="text-black font-weight-bold mb-0" id="progress-start-message"
                                            style="display: none">@lang('layout.robot-progress')</p>
                                        <p class="text-black font-weight-bold mb-0" id="progress-finish-message"
                                            style="display: none">@lang('layout.robot-done')</p>
                                        <div class="progress my-3">
                                            <div class="progress-bar" role="progressbar" style="width: 0%;"
                                                aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"
                                                id="progress-bar-loader"></div>
                                        </div>
                                        <button type="button" class="btn btn-cancel-disabled" disabled name="button"
                                            id="cancel-request-btn">@lang('layout.cancel-btn')</button>
                                    </div>
                                </div>
                            </div>
    ...
    @component('layouts.new_ui_design', [
        ...
        @slot('subcontent_2')
            <div class="d-none" id="description-tab-2">
                ...
                <ul>
                    <li>
                        <p class="text-black">@lang('analyzer.desc-2-1-1')</p>
                    </li>
                    <li>
                        <p class="text-black">@lang('analyzer.desc-2-1-2')</p>
                    </li>
                    <li>
                        <p class="text-black">@lang('analyzer.desc-2-1-3')</p>
                    </li>
                    <li>
                        <p class="text-black">@lang('analyzer.desc-2-1-4')</p>
                    </li>
                    <li>
                        <p class="text-black">@lang('analyzer.desc-2-1-5')</p>
                    </li>
                </ul>
            </div>
        @endslot
        @slot('subcontent_3')
            <div class="d-none" id="description-tab-3">
                ...
                <ul>
                    <li>
                        <p class="text-black">@lang('analyzer.desc-3-1-1')</p>
                    </li>
                    <li>
                        <p class="text-black">@lang('analyzer.desc-3-1-2')</p>
                    </li>
                    <li>
                        <p class="text-black">@lang('analyzer.desc-3-1-3')</p>
                    </li>
                    <li>
                        <p class="text-black">@lang('analyzer.desc-3-1-4')</p>
                    </li>
                </ul>
            </div>
        @endslot
        @slot('subcontent_4')
            <div class="d-none" id="description-tab-4">
                ...
                <ul>
                    <li>
                        <p class="text-black">@lang('analyzer.desc-4-1-1-1')</p>
                    </li>
                    <li>
                        <p class="text-black">@lang('analyzer.desc-4-1-1-2')</p>
                    </li>
                    <li>
                        <p class="text-black">@lang('analyzer.desc-4-1-1-3')</p>
                    </li>
                    <li>
                        <p class="text-black">@lang('analyzer.desc-4-1-1-4')</p>
                    </li>
                    <li>
                        <p class="text-black">@lang('analyzer.desc-4-1-1-5')</p>
                    </li>
                </ul>
            </div>
        @endslot
        @slot('how_to_content')
            <div class="d-none" id="how-to">
                ...
                <div class="expand-text">
                    ...
                    <img class="mb-4" src="{{ asset('/media/images/analyzer_instruction_1.webp') }}" alt="HowTo-analyzer-1"
                        width="80%">
                    @lang('analyzer.howto3')
                    <img class="mb-4" src="{{ asset('/media/images/analyzer_instruction_2.webp') }}" alt="HowTo-analyzer-2"
                        width="80%">
                    @lang('analyzer.howto4')
                    <img class="mb-4" src="{{ asset('/media/images/analyzer_instruction_3.webp') }}" alt="HowTo-analyzer-3"
                        width="80%">
                    @lang('analyzer.howto5')
                    <img class="mb-4" src="{{ asset('/media/images/analyzer_instruction_4.webp') }}" alt="HowTo-analyzer-4"
                        width="80%">
                    @lang('analyzer.howto6')
                    <img class="mb-4" src="{{ asset('/media/images/analyzer_instruction_5.webp') }}" alt="HowTo-analyzer-5"
                        width="80%">
                    @lang('analyzer.howto7')
                    <img class="mb-4" src="{{ asset('/media/images/analyzer_instruction_6.webp') }}" alt="HowTo-analyzer-6"
                        width="80%">
                    @lang('analyzer.howto8')
                    <img class="mb-4" src="{{ asset('/media/images/analyzer_instruction_7.webp') }}" alt="HowTo-analyzer-7"
                        width="80%">
