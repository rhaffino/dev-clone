...
@component('layouts.new_ui_design', ['local' => $local, 'blogs' => $blogs, 'seo_terms' => $seo_terms, 'seo_guidelines' => $seo_guidelines])
    ...
    @slot('subcontent_1')
        ...
        <div class="d-none" id="description-tab-2">
            ...
            <h3 class="sub-titles">@lang('localBusiness.desc-2-2-1')</h3>
            ...
            <h3 class="sub-titles">@lang('localBusiness.desc-2-3-1')</h3>
            <p>@lang('localBusiness.desc-2-3-2')</p>
            <h3 class="sub-titles">@lang('localBusiness.desc-2-4-1')</h3>
            <p>@lang('localBusiness.desc-2-4-2')</p>
            <h3 class="sub-titles">@lang('localBusiness.desc-2-5-1')</h3>
            <p>@lang('localBusiness.desc-2-5-2')</p>
            <p>@lang('localBusiness.desc-2-5-3')</p>
            <h3 class="sub-titles">@lang('localBusiness.desc-2-6-1')</h3>
            <p>@lang('localBusiness.desc-2-6-2')</p>
            <h3 class="sub-titles">@lang('localBusiness.desc-2-7-1')</h3>
            <p>@lang('localBusiness.desc-2-7-2')</p>
            <p>@lang('localBusiness.desc-2-7-3')</p>
            <h3 class="sub-titles">@lang('localBusiness.desc-2-8-1')</h3>
            <p>@lang('localBusiness.desc-2-8-2')</p>
            <p>@lang('localBusiness.desc-2-8-3')</p>
            <h3 class="sub-titles">@lang('localBusiness.desc-2-9-1')</h3>
            <p>@lang('localBusiness.desc-2-9-2')</p>
            <h3 class="sub-titles">@lang('localBusiness.desc-2-10-1')</h3>
