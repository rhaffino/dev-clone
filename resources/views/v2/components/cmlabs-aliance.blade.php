<div class="col-12 col-lg-3">
    ...
    {{-- <div class="storylabs-container mt-10">
        ...
        <div class="storylabs-container-body">
            <a href="https://storylabs.id/{{ $lang }}/backlinks/" target="_blank" rel="noopener noreferrer"
                class="storylabs-button green-story-labs">
                <img src="{{ asset('media/images/storylabs-backlink.svg') }}" alt="backlink icon storylabs">
                <div class="b2-400 b2-m-400">Backlink</div>
            </a>
            <a href="https://storylabs.id/{{ $lang }}/advertorials/" target="_blank" rel="noopener noreferrer"
                class="storylabs-button green-story-labs">
            ...
            <a href="https://storylabs.id/{{ $lang }}/ad-placements/" target="_blank" rel="noopener noreferrer"
                class="storylabs-button green-story-labs">
                <img src="{{ asset('media/images/storylabs-ad.svg') }}" alt="ad placement icon storylabs">
                <div class="b2-400 b2-m-400">Ad Placement</div>
            </a>
            <a href="https://storylabs.id/{{ $lang }}/partnerships/" target="_blank" rel="noopener noreferrer"
                class="storylabs-button green-story-labs">
