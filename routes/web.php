...
Route::middleware([ManualAuth::class])->group(function () {
    ...
    Route::middleware([EnsureUrlIsValid::class])->group(function () {
        ...
        Route::get('/{lang}/robotstxt-generator', 'ToolsController@robotgenerator')->name('robotstxt-generator');
        ...
        Route::get('/{lang}/keyword-permutation', 'ToolsController@keywordpermutation')->name('keyword-permutation');
